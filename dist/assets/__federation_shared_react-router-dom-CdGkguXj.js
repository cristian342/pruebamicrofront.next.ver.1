  ...
  let scriptTag = value ? /* @__PURE__ */ React4$1.createElement(
    "script",
    {
      ...
      dangerouslySetInnerHTML: {
        __html: `window.__reactRouterContext.streamController.enqueue(${escapeHtml$1(
...
const React5$1 = await importShared('react');

function RemixRootDefaultHydrateFallback() {
  return /* @__PURE__ */ React5$1.createElement(BoundaryShell, { title: "Loading...", renderScripts: true }, /* @__PURE__ */ React5$1.createElement(
    "script",
    {
      dangerouslySetInnerHTML: {
        __html: `
